...
/*
 * Orange sprite filenames (avatar 0)
 * Walk:   down1-4, left1-4, right1-4, up1-4
 * Attack: ad1-4, al1-4, ar1-4, au1-4
 * Death:  death1-4
 *
 * Yellow sprite filenames (avatar 1)
 * Walk:   yd1-4, yl1-4, yr1-4, yu1-4
 * Attack: yad1-4, yal1-4, yar1-4, yau1-4
 * Death:  ydeath1-4
 */
...
int initPlayer(Player* player, SDL_Renderer* renderer, int avatar)
{
    ...
    /* Unused walk slots (frames 4-8) set to NULL */
    for (int i = 0; i < DIRECTIONS; i++)
    ...
    /* ---- Death frames ---- */
    const char* deathNames[DEATH_FRAMES];
    if (avatar == 0) {
        deathNames[0] = "death1.png";
        deathNames[1] = "death2.png";
        deathNames[2] = "death3.png";
        deathNames[3] = "death4.png";
    } else {
        deathNames[0] = "ydeath1.png";
        deathNames[1] = "ydeath2.png";
        deathNames[2] = "ydeath3.png";
        deathNames[3] = "ydeath4.png";
    }
    for (int i = 0; i < DEATH_FRAMES; i++)
        player->deathAnim[i] = loadTexture(renderer, deathNames[i]);
...
void handleInput(Player* player, const Uint8* keystate, SDL_Surface* mask)
{
    ...
    if (player->inputScheme == INPUT_WASD) {
        ...
        atk    = SDL_SCANCODE_RETURN;
        sprint = SDL_SCANCODE_RSHIFT;
    }
